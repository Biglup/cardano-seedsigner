######################################################################
#  Patched renderer.py for desktop emulator
#
#  Original SeedSigner renderer.py modified to use desktopDisplay
...
class Renderer(ConfigurableSingleton):
    ...
    def is_screenshot_generator(self) -> bool:
        """Return False - this is not a screenshot generator."""
        return False
    ...
    def initialize_display(self):
        # May be called while already running with a previous display driver
        self.lock.acquire()
